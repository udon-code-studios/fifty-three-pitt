  ...
  return (
    <div className="grow flex flex-col items-center justify-between">
      <div className="pb-2 w-full flex flex-col items-center">
        {/* about */}
        <div className="pt-14 pb-20 pl-8 px-8 w-full flex grow max-w-4xl items-center text-sm">
          <div className="w-1/3">
            <Image src="/wburgbr_4x3_color.jpg" alt="williamsburg bridge" width={600} height={600} />
          </div>
          <div className="w-2/3 pl-8 -mt-6 flex flex-col items-center justify-between space-y-3">
            <h2 className="w-full text-2xl font-semibold">About</h2>
            <p className="w-full">
              Fifty-Three Pitt is a boutique investment firm which specializes in equity research and financial
              education. With nearly 2 days of experience in the financial industry, we have a proven track record of
              delivering consistently middling results for our clients.
            </p>
          </div>
        </div>
